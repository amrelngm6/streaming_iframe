...
class BookGenreController extends CustomController
{
	...
	*/
	...
	public function index(  ) 
	{
	    return render('categories', [
	        'load_vue' => true,
	        'title' => translate('Books Genres'),
	        'items' => $this->repo->getAllBookGenres(100),
	...
	public function store() 
	{
        ...
        try {	
			...
			$params['model'] = \Medians\Categories\Domain\BookGenre::class;
