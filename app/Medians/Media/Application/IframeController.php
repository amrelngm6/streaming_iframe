...
class IframeController extends CustomController 
{
	...
	public function index(  ) 
	{
	    return render('media', [
	        'load_vue' => true,
	        'title' => translate('Iframes'),
	        'items' => $this->repo->getByType('iframe'),
     ...
     */
    public function studio_iframes()
    {
        ...
        $params['limit'] = $settings['view_iframes_limit'] ?? null;
		...
		try 
        {
            return printResponse(render('views/front/'.($settings['template'] ?? 'default').'/layout.html.twig', [
                ...
                'customer' => $customer,
                'list' => $list,
                'layout' => isset($this->app->customer->customer_id) ? 'iframe/studio' : 'signin'
            ], 'output'));
     ...
     */
    public function iframe_upload_page()
    {
		$settings = $this->app->SystemSetting();
    ...
    /**
     * Import Iframe file from external link
     */
     ...
     */
    public function edit_iframe($media_id)
    {
		$this->app->customer_auth();
	...
	{	
        ...
        try {	
			...
			try {
				...
				return $returnData
				? array('success'=>1, 'result'=>translate('Added'), 'redirect'=>'/iframe/edit/'.$returnData->media_id)
